 ...
 * Generated for Laravel 5.8.35 on 2019-10-27 17:49:13.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Request {
         ...
         *
         * Suppose that an rule.php file instantiates this request object:
         *
         ...
         * script filename (e.g. rule.php) if one exists.
         *
