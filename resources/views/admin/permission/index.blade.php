        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加权限','/admin/permission/add',600,400)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <a title="编辑"  onclick="xadmin.open('编辑','/admin/permission/update/{{$permission['id']}}')" href="javascript:;">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>
                                <a title="删除" onclick="member_del(this,{{$permission['id']}})" href="javascript:;">
                                    <i class="layui-icon">&#xe640;</i>
                                </a>
                            </td>
                        </tr>
